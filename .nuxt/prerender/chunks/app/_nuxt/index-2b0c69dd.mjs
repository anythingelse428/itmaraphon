  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_a = history[0]) == null ? void 0 : _a.info.length) > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "history" }, _attrs))} data-v-51d5f5c9><div class="history__pagination" data-v-51d5f5c9>`);
        _push(ssrRenderComponent(PaginationNav, {
          pagesQty: history.length,
          current: currentPage.value
        }, null, _parent));
        _push(`</div><div class="history__row" data-v-51d5f5c9><!--[-->`);
...
const HistoryLine = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-51d5f5c9"]]);
...
//# sourceMappingURL=index-2b0c69dd.mjs.map
