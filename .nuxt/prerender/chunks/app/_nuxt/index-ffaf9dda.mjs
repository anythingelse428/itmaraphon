...
=======
import { useSSRContext, defineComponent, ref, mergeProps, unref } from 'file://C:/stuff/it-maraphon/node_modules/vue/index.mjs';
import { _ as _export_sfc, b as useRoute, u as useRouter } from '../server.mjs';
import { onBeforeRouteUpdate } from 'file://C:/stuff/it-maraphon/node_modules/vue-router/dist/vue-router.node.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderClass } from 'file://C:/stuff/it-maraphon/node_modules/vue/server-renderer/index.mjs';
...
import 'file://C:/stuff/it-maraphon/node_modules/ufo/dist/index.mjs';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-f773a3dc><div class="history-item__header" data-v-f773a3dc><div class="history-item__year" data-v-f773a3dc>${ssrInterpolate($props.year)}</div><div class="history-item__description" data-v-f773a3dc>${ssrInterpolate($props.shortDescripton)}</div></div><div class="history-item__step" data-v-f773a3dc><div class="small-light" data-v-f773a3dc></div><div class="big-light" data-v-f773a3dc></div></div><div class="${ssrRenderClass("history-item__line" + ($props.isReversed ? " --reversed" : ""))}" data-v-f773a3dc><div class="history-item__line --main" data-v-f773a3dc><div class="svg" data-v-f773a3dc></div></div><div class="history-item__line --sub" data-v-f773a3dc><div class="svg" data-v-f773a3dc></div><div class="history-item__info" data-v-f773a3dc>${ssrInterpolate($props.info)}</div></div></div></div>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-f773a3dc"]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (((_a = $data.history[0]) == null ? void 0 : _a.info.length) > 0) {
    _push(`<div${ssrRenderAttrs(mergeProps({ class: "history" }, _attrs))} data-v-7e34fa70><div class="history__pagination" data-v-7e34fa70>`);
    _push(ssrRenderComponent(_component_PaginationNav, {
      pagesQty: $data.history.length
    }, null, _parent));
    _push(`</div><div class="history__row" data-v-7e34fa70><!--[-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-7e34fa70"]]);
const _sfc_main = {
  name: "MainPage",
...
//# sourceMappingURL=index-ffaf9dda.mjs.map
