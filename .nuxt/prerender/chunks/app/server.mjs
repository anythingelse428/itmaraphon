import { version, useSSRContext, hasInjectionContext, getCurrentInstance, inject, ref, watchEffect, watch, defineComponent, withCtx, createVNode, createApp, reactive, unref, computed, h, Suspense, nextTick, Transition, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, mergeProps, defineAsyncComponent, isRef, isShallow, isReactive, toRaw } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/vue/index.mjs';
...
import { getContext, executeAsync } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/unctx/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol as hasProtocol$1, parseURL, joinURL as joinURL$1 } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/ufo/dist/index.mjs';
import { renderSSRHead } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/@unhead/ssr/dist/index.mjs';
import { composableNames, getActiveHead, unpackMeta, createServerHead as createServerHead$1 } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/@unhead/shared/dist/index.mjs';
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/vue/server-renderer/index.mjs';
import { defu as defu$1 } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/defu/dist/defu.mjs';
import { useSchemaOrg, defineOrganization } from 'file://C:/Users/anythingelse428/Documents/GitHub/itmaraphon/node_modules/@unhead/schema-org/dist/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d37959d8.mjs').then((m) => m.default || m)
  }
];
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }, { "name": "keywords", "content": "УавиаК-МЦК,колледж,УАвиаК,техникум" }, { "name": "description", "content": "Сайт УавиаК-МЦК" }, { "name": "robots", "content": "all" }, { "http-equiv": "content-type", "content": "text/html; charset=UTF-8" }, { "http-equiv": "Permissions-Policy", "content": "interest-cohort=()" }, { "name": "msapplication-TileColor", "content": "#2b5797" }, { "name": "theme-color", "content": "#ffffff" }], "link": [{ "rel": "apple-touch-icon", "sizes": "180x180", "href": "apple-touch-icon.png" }, { "rel": "icon", "type": "image/png", "sizes": "32x32", "href": "favicon-32x32.png" }, { "rel": "icon", "type": "image/png", "sizes": "16x16", "href": "favicon-16x16.png" }, { "rel": "manifest", "href": "site.webmanifest" }, { "rel": "mask-icon", "color": "#5bbad5", "href": "safari-pinned-tab.svg" }], "style": [], "script": [], "noscript": [{ "children": "JavaScript в вашем браузере отключен, пожалуйста, включите JavaScript или зайдите через другой браузер" }], "charset": "utf-8", "viewport": "width=device-width, initial-scale=1", "title": "УавиаК-МЦК" };
...
const config = { "host": "https://anythingelse428.github.io/itmaraphon/", "trailingSlash": false };
...
const layouts = {
  default: () => import('./_nuxt/default-c3412b18.mjs').then((m) => m.default || m)
};
  ...
  setup(__props) {
    useNuxtApp().hook("page:finish", () => {
      ...
      if ($loader && $body) {
        ...
        $loader == null ? void 0 : $loader.addEventListener("transitionend", () => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-8b541c29.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-6db50259.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-4ecb3b31.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useRouter as a, createError as c, entry$1 as default, navigateTo as n, useHead as u };
