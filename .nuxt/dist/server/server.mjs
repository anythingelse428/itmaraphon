...
import { createServerHead as createServerHead$1, getActiveHead, unpackMeta, composableNames } from "unhead";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-fd51378d.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-af5ef84e.js").then((m) => m.default || m)
};
