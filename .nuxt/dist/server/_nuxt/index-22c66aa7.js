...
const HistoryItem_vue_vue_type_style_index_0_scoped_c2143b0d_lang = "";
const _sfc_main$2 = {
  name: "HistoryItem",
  props: {
    year: {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-c2143b0d><div class="history-item__header" data-v-c2143b0d><div class="history-item__year" data-v-c2143b0d>${ssrInterpolate($props.year)}</div><div class="history-item__description" data-v-c2143b0d>${ssrInterpolate($props.shortDescripton)}</div></div><div class="history-item__step" data-v-c2143b0d><div class="small-light" data-v-c2143b0d></div><div class="big-light" data-v-c2143b0d></div></div><div class="${ssrRenderClass("history-item__line" + ($props.isReversed ? " --reversed" : ""))}" data-v-c2143b0d><div class="history-item__line --main" data-v-c2143b0d><div class="svg" data-v-c2143b0d></div></div><div class="history-item__line --sub" data-v-c2143b0d><div class="svg" data-v-c2143b0d></div><div class="history-item__info" data-v-c2143b0d>${ssrInterpolate($props.info)}</div></div></div></div>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-c2143b0d"]]);
...
//# sourceMappingURL=index-22c66aa7.js.map
