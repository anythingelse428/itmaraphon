...
const NavigationMenu_vue_vue_type_style_index_0_scoped_a1068803_lang = "";
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NavigationLink = __nuxt_component_0$1;
  _push(`<nav${ssrRenderAttrs(mergeProps({
    class: "nav",
    ref: "nav"
  }, _attrs))} data-v-a1068803><div class="nav-brand" data-v-a1068803><img${ssrRenderAttr("src", _imports_0)} width="103" height="60" alt="УавиаК-МЦК" srcset="" data-v-a1068803></div><div class="${ssrRenderClass([$data.isOpened && "active", "nav-collapse"])}" data-v-a1068803><div class="nav-links" data-v-a1068803>`);
  ...
  _push(`</div></div><div class="nav-tools" data-v-a1068803><div class="nav-tool" data-v-a1068803><img${ssrRenderAttr("src", _imports_1)} alt="Поиск" width="18" height="18" data-v-a1068803></div><div class="nav-tool" data-v-a1068803><img${ssrRenderAttr("src", _imports_2)} alt="Версия для слабовидящих" width="26" height="18" data-v-a1068803></div><div class="${ssrRenderClass([$data.isOpened && "active", "nav-toggler"])}" data-v-a1068803></div></div></nav>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-a1068803"]]);
const _sfc_main = {
  components: {
...
//# sourceMappingURL=default-c5f2cd73.js.map
