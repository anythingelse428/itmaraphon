...
const HistoryLine_vue_vue_type_style_index_0_scoped_ce0a21cc_lang = "";
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (((_a = $data.history[0]) == null ? void 0 : _a.info.length) > 0) {
    _push(`<div${ssrRenderAttrs(mergeProps({ class: "history" }, _attrs))} data-v-ce0a21cc><div class="history__pagination" data-v-ce0a21cc>`);
    _push(ssrRenderComponent(_component_PaginationNav, {
      pagesQty: $data.history.length
    }, null, _parent));
    _push(`</div><div class="history__row" data-v-ce0a21cc><!--[-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-ce0a21cc"]]);
const _sfc_main = {
  name: "MainPage",
...
//# sourceMappingURL=index-f3916f39.js.map
