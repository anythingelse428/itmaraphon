...
const NavigationMenu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7244185f"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "default",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout --default" }, _attrs))} data-v-a9e1d0c3>`);
      _push(ssrRenderComponent(NavigationMenu, null, null, _parent));
      _push(`<main class="container" data-v-a9e1d0c3>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</main><footer data-v-a9e1d0c3></footer></div>`);
    };
  }
});
const default_vue_vue_type_style_index_0_scoped_a9e1d0c3_lang = "";
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a9e1d0c3"]]);
export {
  _default as default
};
//# sourceMappingURL=default-7f831517.js.map
