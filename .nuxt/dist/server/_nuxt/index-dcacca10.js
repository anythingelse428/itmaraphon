...
const HistoryItem_vue_vue_type_style_index_0_scoped_350bad76_lang = "";
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: ($options.isCurrent ? "--current" : "--muted") + ($props.isReversed && $data.isDesktop ? " --reversed" : "") + " history-item"
  }, _attrs))} data-v-350bad76><div class="history-item__header" data-v-350bad76><div class="history-item__year" data-v-350bad76>${ssrInterpolate($props.year)}</div><div class="history-item__description" data-v-350bad76>${ssrInterpolate($props.shortDescripton)}</div></div><div class="history-item__step" data-v-350bad76><div class="small-light" data-v-350bad76></div><div class="big-light" data-v-350bad76></div></div><div class="history-item__line" data-v-350bad76><div class="history-item__line --main" data-v-350bad76><div class="svg" data-v-350bad76></div></div><div class="history-item__line --sub" data-v-350bad76><div class="svg" data-v-350bad76></div><div class="history-item__info" data-v-350bad76>${ssrInterpolate($props.info)}</div></div></div></section>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-350bad76"]]);
...
//# sourceMappingURL=index-dcacca10.js.map
