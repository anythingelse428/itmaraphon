...
const HistoryItem_vue_vue_type_style_index_0_scoped_accaa11f_lang = "";
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: ($options.isCurrent ? "--current" : "--muted") + ($props.isReversed && $data.isDesktop ? " --reversed" : "") + " history-item"
  }, _attrs))} data-v-accaa11f><div class="history-item__header" data-v-accaa11f><div class="history-item__year" data-v-accaa11f>${ssrInterpolate($props.year)}</div><div class="history-item__description" data-v-accaa11f>${ssrInterpolate($props.shortDescripton)}</div></div><div class="history-item__step" data-v-accaa11f><div class="small-light" data-v-accaa11f></div><div class="big-light" data-v-accaa11f></div></div><div class="history-item__line" data-v-accaa11f><div class="history-item__line --main" data-v-accaa11f><div class="svg" data-v-accaa11f></div></div><div class="history-item__line --sub" data-v-accaa11f><div class="svg" data-v-accaa11f></div><div class="history-item__info" data-v-accaa11f>${ssrInterpolate($props.info)}</div></div></div></section>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-accaa11f"]]);
...
//# sourceMappingURL=index-b12fc878.js.map
