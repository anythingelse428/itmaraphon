...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mainpage" }, _attrs))} data-v-ac76e755><div class="hero" data-v-ac76e755><h1 class="hero__title" data-v-ac76e755>ОГАПОУ «УАвиаК-МЦК»</h1><h2 class="hero__description" data-v-ac76e755> Областное государственное автономное профессиональное образовательное учреждение «Ульяновский авиационный колледж — Межрегиональный центр компетенций» </h2></div>`);
      _push(ssrRenderComponent(HistoryLine, null, null, _parent));
      _push(`</div>`);
    };
  }
});
const index_vue_vue_type_style_index_0_scoped_ac76e755_lang = "";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac76e755"]]);
export {
  index as default
};
//# sourceMappingURL=index-d37959d8.js.map
