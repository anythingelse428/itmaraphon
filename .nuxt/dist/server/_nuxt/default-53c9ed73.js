...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout --default" }, _attrs))} data-v-d17fb8bf>`);
      _push(ssrRenderComponent(NavigationMenu, null, null, _parent));
      _push(`<main class="container" data-v-d17fb8bf>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</main><footer data-v-d17fb8bf></footer></div>`);
    };
  }
});
const default_vue_vue_type_style_index_0_scoped_d17fb8bf_lang = "";
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d17fb8bf"]]);
export {
  _default as default
};
//# sourceMappingURL=default-53c9ed73.js.map
