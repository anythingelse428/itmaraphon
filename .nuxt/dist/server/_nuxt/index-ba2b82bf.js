...
const HistoryItem_vue_vue_type_style_index_0_scoped_2a9ba5c2_lang = "";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mainpage" }, _attrs))} data-v-71ea88bf><div class="hero" data-v-71ea88bf><h1 class="hero__title" data-v-71ea88bf>ОГАПОУ «УАвиаК-МЦК»</h1><h2 class="hero__description" data-v-71ea88bf> Областное государственное автономное профессиональное образовательное учреждение «Ульяновский авиационный колледж — Межрегиональный центр компетенций» </h2></div>`);
      _push(ssrRenderComponent(HistoryLine, null, null, _parent));
      _push(`</div>`);
    };
  }
});
const index_vue_vue_type_style_index_0_scoped_71ea88bf_lang = "";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-71ea88bf"]]);
export {
  index as default
};
//# sourceMappingURL=index-ba2b82bf.js.map
