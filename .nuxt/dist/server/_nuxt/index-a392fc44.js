...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mainpage" }, _attrs))} data-v-83e9f5bb><section class="hero" data-v-83e9f5bb><h1 class="hero__title" data-v-83e9f5bb>ОГАПОУ «УАвиаК-МЦК»</h1><h2 class="hero__description" data-v-83e9f5bb> Областное государственное автономное профессиональное образовательное учреждение «Ульяновский авиационный колледж — Межрегиональный центр компетенций» </h2></section>`);
      _push(ssrRenderComponent(HistoryLine, null, null, _parent));
      _push(`</div>`);
    };
  }
});
const index_vue_vue_type_style_index_0_scoped_83e9f5bb_lang = "";
...
//# sourceMappingURL=index-a392fc44.js.map
