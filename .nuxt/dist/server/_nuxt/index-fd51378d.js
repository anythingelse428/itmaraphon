...
const HistoryItem_vue_vue_type_style_index_0_scoped_e37020b0_lang = "";
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: ($options.isCurrent ? "--current" : "--muted") + ($props.isReversed && $data.isDesktop ? " --reversed" : "") + " history-item"
  }, _attrs))} data-v-e37020b0><div class="history-item__header" data-v-e37020b0><div class="history-item__year" data-v-e37020b0>${ssrInterpolate($props.year)}</div><div class="history-item__description" data-v-e37020b0>${ssrInterpolate($props.shortDescripton)}</div></div><div class="history-item__step" data-v-e37020b0><div class="small-light" data-v-e37020b0></div><div class="big-light" data-v-e37020b0></div></div><div class="history-item__line" data-v-e37020b0><div class="history-item__line --main" data-v-e37020b0><div class="svg" data-v-e37020b0></div></div><div class="history-item__line --sub" data-v-e37020b0><div class="svg" data-v-e37020b0></div><div class="history-item__info" data-v-e37020b0>${ssrInterpolate($props.info)}</div></div></div></section>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-e37020b0"]]);
...
const HistoryLine_vue_vue_type_style_index_0_scoped_5f881d44_lang = "";
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (((_a = $data.history[0]) == null ? void 0 : _a.info.length) > 0) {
    _push(`<div${ssrRenderAttrs(mergeProps({ class: "history" }, _attrs))} data-v-5f881d44><div class="history__pagination" data-v-5f881d44>`);
    _push(ssrRenderComponent(_component_PaginationNav, {
      pagesQty: $data.history.length
    }, null, _parent));
    _push(`</div><div class="history__row" data-v-5f881d44><!--[-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-5f881d44"]]);
const _sfc_main = {
  name: "MainPage",
...
//# sourceMappingURL=index-fd51378d.js.map
