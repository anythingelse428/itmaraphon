...
const PaginationBullet_vue_vue_type_style_index_0_scoped_982e0dfd_lang = "";
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "pagination-bullet" + ($options.isActive ? " active" : "")
  }, _attrs))} data-v-982e0dfd></div>`);
}
...
const PaginationBullet = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-982e0dfd"]]);
...
const HistoryItem_vue_vue_type_style_index_0_scoped_1beaf3be_lang = "";
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: ($options.isCurrent ? "--current" : "--muted") + ($props.isReversed && $data.isDesktop ? " --reversed" : "") + " history-item"
  }, _attrs))} data-v-1beaf3be><div class="history-item__header" data-v-1beaf3be><div class="history-item__year" data-v-1beaf3be>${ssrInterpolate($props.year)}</div><div class="history-item__description" data-v-1beaf3be>${ssrInterpolate($props.shortDescripton)}</div></div><div class="history-item__step" data-v-1beaf3be><div class="small-light" data-v-1beaf3be></div><div class="big-light" data-v-1beaf3be></div></div><div class="history-item__line" data-v-1beaf3be><div class="history-item__line --main" data-v-1beaf3be><div class="svg" data-v-1beaf3be></div></div><div class="history-item__line --sub" data-v-1beaf3be><div class="svg" data-v-1beaf3be></div><div class="history-item__info" data-v-1beaf3be>${ssrInterpolate($props.info)}</div></div></div></section>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-1beaf3be"]]);
...
const HistoryLine_vue_vue_type_style_index_0_scoped_505b09f8_lang = "";
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (((_a = $data.history[0]) == null ? void 0 : _a.info.length) > 0) {
    _push(`<div${ssrRenderAttrs(mergeProps({ class: "history" }, _attrs))} data-v-505b09f8><div class="history__pagination" data-v-505b09f8>`);
    _push(ssrRenderComponent(_component_PaginationNav, {
      pagesQty: $data.history.length
    }, null, _parent));
    _push(`</div><div class="history__row" data-v-505b09f8><!--[-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-505b09f8"]]);
const _sfc_main = {
  name: "MainPage",
  components: { HistoryLine: __nuxt_component_0 }
};
const index_vue_vue_type_style_index_0_scoped_036670bf_lang = "";
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_HistoryLine = __nuxt_component_0;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "mainpage" }, _attrs))} data-v-036670bf><div class="hero" data-v-036670bf><h1 class="hero__title" data-v-036670bf>ОГАПОУ «УАвиаК-МЦК»</h1><div class="hero__description" data-v-036670bf> Областное государственное автономное профессиональное образовательное учреждение «Ульяновский авиационный колледж — Межрегиональный центр компетенций» </div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-036670bf"]]);
export {
  index as default
};
//# sourceMappingURL=index-8a546dfb.js.map
